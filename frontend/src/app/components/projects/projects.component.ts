  ...
  projects: Project[] = [
    {
      ...
      description: 'Collects news from various channels, groups items using semantic similarity, and generates AI-powered summaries to reduce information overload. Exposes features via MCP.',
      tags: ['Java 25', 'Spring AI', 'PostgreSQL', 'MCP'],
    },
    {
      category: 'PET PROJECT',
      year: '2025',
